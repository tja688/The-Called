...
const RULES = [
  ...
  {
    title: '牌面效果',
    body: '有的牌没有额外效果，只提供点数。其余效果都在放下时结算：改变相邻己方或对方的 Power；在边缘、四角或正中给自己加点；旁边有指定阵营，或此时没有相邻己方牌时给自己加点；盖住对方时给自己加点；看中心对称格，给自己加点或降低对称格上的对手；降低同一行或同一列里的对手；降低棋盘边缘上的对手；当场上己方牌达到一定张数时给自己加点。',
  },
  {
    title: '怪物',
